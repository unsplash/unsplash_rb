module Unsplash # :nodoc:
  ...
  class Photo < Client
    ...
    class << self
      ...
      # @param per_page [Integer] The number of photos search result per page. (default: 10, maximum: 30)
      # @return [Hash] with :total and :total_pages keys from pagination metada and :results, a [Array] list of +Unsplash::Photo+ objects.
